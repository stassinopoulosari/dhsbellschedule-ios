...
struct HomeScreenWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = HomeScreenWidgetAttributes(name: "Me")
    static let contentState = HomeScreenWidgetAttributes.ContentState(value: 3)
